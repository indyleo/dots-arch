...
echo "## Yay Programs ##"
echo "##################"
yay -S --answerdiff None --answerclean None --mflags "--noconfirm" cava vscodium-bin swaylock-effects rofi-lbonn-wayland-git brave-bin autojump hollywood swaync tty-clock
...
echo "#####################"
flatpak install net.lutris.Lutris org.fedoraproject.MediaWriter com.github.tchx84.Flatseal xyz.xclicker.xclicker org.nickvision.tubeconverter com.discordapp.Discord 
